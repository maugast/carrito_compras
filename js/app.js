...
//Muestra el curso seleccionadon en el Carrito
...
function guardarCursoLocalStorage (curso){
    ...
    //El curso deleccionado se agrega al arreglo
    cursos.push(curso);
...
function eliminarCursoLocalStorage(curso){
    ...
    cursosLS = obtenerCursosLocalStorage();
    //Iteramos comparando los ID del curso borrado con los de Local Storage
